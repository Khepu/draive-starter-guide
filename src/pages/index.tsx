...
const HomeBody = (): JSX.Element => (
  <div className={clsx("container", styles.body)}>
    <p>
      ...
      at least the parts that are common across draive, to any new team members.
      After reading it, you should feel comfortable enough with our naming
      conventions, know where to find new tasks, and where to ask for help.
    </p>
    <p>
